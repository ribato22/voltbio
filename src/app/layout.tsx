    ...
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <meta
          ...
          content="default-src 'self'; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: blob:; connect-src 'self'; object-src 'none'; frame-src 'self' https: data: blob:; base-uri 'self'; form-action 'self';"
        />
